...
<link href="<?php echo e(URL::asset('assets/plugins/leaflet/leaflet.css')); ?>" rel="stylesheet">
...
<script src="<?php echo e(URL::asset('assets/plugins/leaflet/leaflet.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/js/map-leafleft.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\courses\laravel\project-pos\resources\views/map-leaflet.blade.php ENDPATH**/ ?>