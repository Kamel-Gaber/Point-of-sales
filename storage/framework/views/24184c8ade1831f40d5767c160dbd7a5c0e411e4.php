...
<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="text-left navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="index.html"><img src="<?php echo e(URL::asset('backend/assets/images/logo-dark.png')); ?>" alt="" ></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="<?php echo e(URL::asset('backend/assets/images/logo-icon-dark.png')); ?>" alt=""></a>
    </div>
    <!-- Top bar left -->
    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <div class ="btn-group mb-1">
            ...
            <?php if(App::getLocale()== 'ar' ): ?>
                ...
                <img src="<?php echo e(URL::asset('backend/flags/EG.png')); ?>" alt="">
            <?php else: ?>
                    <?php echo e(LaravelLocalization::getCurrentLocaleName()); ?>

                <img src="<?php echo e(URL::asset('backend/flags/US.png')); ?>" alt="">
                <?php endif; ?>
                </button>
        ...
        <li class="nav-item dropdown mr-30">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#"><i class="text-secondary"></i><?php echo e(Auth::user()->email); ?></a>
                ...
                <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="text-danger ti-unlock"></i>Logout</a>

                <form id="logout-form" action="<?php echo e(\LaravelLocalization::localizeURL('/logout')); ?>" method="POST" style="display: none;">
...
<!--=================================
 header End-->
<?php /**PATH F:\courses\laravel\project-pos\resources\views/layouts/backend/main-header.blade.php ENDPATH**/ ?>