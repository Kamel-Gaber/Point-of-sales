...
{{--         </ul>--}}
        <div class ="btn-group mb-1">
            ...
            @else
                    {{LaravelLocalization::getCurrentLocaleName() }}
                <img src="{{URL::asset('backend/flags/US.png')}}" alt="">
                @endif
                </button>
        ...
        <li class="nav-item dropdown mr-30">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#"><i class="text-secondary"></i>{{Auth::user()->email}}</a>
                ...
                <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="text-danger ti-unlock"></i>Logout</a>
